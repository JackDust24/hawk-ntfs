...
export class NftItemCall extends ethereum.Call {
  get inputs(): NftItemCall__Inputs {
    return new NftItemCall__Inputs(this);
  }

  get outputs(): NftItemCall__Outputs {
    return new NftItemCall__Outputs(this);
  }
}

export class NftItemCall__Inputs {
  _call: NftItemCall;

  constructor(call: NftItemCall) {
    this._call = call;
  }
...
export class NftItemCall__Outputs {
  _call: NftItemCall;
